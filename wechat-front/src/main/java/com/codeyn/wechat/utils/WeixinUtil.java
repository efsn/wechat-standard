...
public class WeixinUtil {
	...
	protected final static Logger logger = LoggerFactory.getLogger(WeixinUtil.class);

	/**
	 * 封装微信认证重定向URL
	 */
	public static String encaAuthorizeUrl(String appId, WxJFinalBaseController wxJFinalBaseController) {
	 ...
	 * 获取当前URL-特殊，其它模块不要使用
	 */
	public static String getSourceUrl(WxJFinalBaseController wxJFinalBaseController) {
