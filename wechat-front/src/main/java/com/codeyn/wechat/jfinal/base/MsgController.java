...
import com.codeyn.wechat.jfinal.controller.MsgController;
...
public abstract class MsgController extends Controller {
	...
	private String getReceivedXmlMsg() {
	    ...
	    WxBase base = WxCache.getWxBase("");
		if (base.isEncrypt()) {
			inMsgXml = MsgEncryptUtil.decrypt(base, inMsgXml, getPara("timestamp"), getPara("nonce"), getPara("msg_signature"));
		}
