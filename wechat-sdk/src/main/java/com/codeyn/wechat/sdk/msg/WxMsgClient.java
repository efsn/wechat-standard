...
import com.sqq.tbms.sdk.base.AppBase;
import com.sqq.tbms.sdk.base.BaseClient;
import com.sqq.tbms.sdk.base.PreParamService;
 ...
 *
 */
public class WxMsgClient extends BaseClient {

	public WxMsgClient(AppBase appBase) {
	...
	public DataResult sendMsg(final String memberId, final Integer msgType, final Map<String, Object> params) {
		return doService(DataResult.class, new PreParamService() {
			@Override
			public void preMap(Map<String, Object> map) {
	...
	public static void main(String args[]) {
        AppBase appBase = new AppBase("2", "http://localhost:8080", "test");
